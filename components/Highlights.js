...
import { Alert, Button, ToastAndroid, Linking } from "react-native";
...
export default function Highlights() {
  ...
  function fetchData() {
    fetch(
      "https://l8seb8lrle.execute-api.eu-north-1.amazonaws.com/EventsData/events/?startIndex=0&endIndex=100"
    )
